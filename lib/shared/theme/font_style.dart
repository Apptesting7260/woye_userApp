...
class AppFontStyle {
  ...
  static text_14_300(Color color, {height}) {
    return _textStyle(color, 14.sp, FontWeight.w300, TextOverflow.ellipsis,
        height: height);
  }
  ...
  static text_16_500(Color color, {height}) {
    return _textStyle(color, 16.sp, FontWeight.w500, TextOverflow.ellipsis,
        height: height);
  }
  ...
  static text_16_600(Color color, {height}) {
    return _textStyle(color, 16.sp, FontWeight.w600, TextOverflow.ellipsis,
        height: height);
  }
  ...
  static text_40_600(Color color, {height}) {
    return _textStyle(color, 40.sp, FontWeight.w600, TextOverflow.ellipsis,
        height: height);
  }
  ...
  static text_16_800(Color color, {height}) {
    return _textStyle(color, 16.sp, FontWeight.w800, TextOverflow.ellipsis,
        height: height);
  }
