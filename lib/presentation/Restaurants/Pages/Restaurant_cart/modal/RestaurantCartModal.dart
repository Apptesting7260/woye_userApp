...
class DecodedAttribute {
  ...
  String? quantity;
  String? price;
  List<String>? addons; // Addons field as List of Strings
  List<Attribute>? attribute;
  String? productName;
  String? productImage;
  int? totalPrice;
  List<String>? addonName; // New field for addon names
  ...
  factory DecodedAttribute.fromJson(Map<String, dynamic> json) {
    ...
    return DecodedAttribute(
      ...
      price: json['price'],
      addons: List<String>.from(json['addons'] ?? []), // Handle addons as List of Strings
      attribute: attributeList ?? [],
      productName: json['product_name'],
      productImage: json['product_image'],
      totalPrice: json['total_price'],
      addonName: List<String>.from(json['addon_name'] ?? []), // Handle addon names
    );
  }
