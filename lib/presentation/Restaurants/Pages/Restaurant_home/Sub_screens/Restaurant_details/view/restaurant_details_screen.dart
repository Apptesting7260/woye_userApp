...
import 'package:woye_user/shared/widgets/sliverPinnedHeaderDelegate.dart' show SliverPinnedHeaderDelegate;
import 'package:woye_user/shared/widgets/updated_custom_item_banner.dart';
...
class _RestaurantDetailsScreenState extends State<RestaurantDetailsScreen> {
              ...
              return RefreshIndicator(
                ...
                child: CustomScrollView(
                  slivers: [
                   ...
                   /* if (controller.restaurant_Data.value.highlights?.isNotEmpty ?? false)
                      SliverToBoxAdapter(
                        // child: highlights(widget.Restaurantid),
                      )
                    ...
                    if ((controller.restaurant_Data.value.categories?.data.isNotEmpty ?? false)
                        && controller.categoriesIndex.value != 0)
                      SliverToBoxAdapter(
                        child: categoriesProducts(context, widget.Restaurantid),
                      ),
        ...
        Obx(
          () => SizedBox(
            ...
            child: ListView.separated(
              ...
              shrinkWrap: true,
              itemCount:
                  controller.restaurant_Data.value.highlights?.length ?? 0,
              itemBuilder: (context, index) {
                controller.restaurant_Data.value.highlights![index].isInWishlist
                    .value = controller.restaurant_Data.value.highlights![index]
                            .isWishlist ==
                        "true"
                    ? true
                    : false;
                final item =
                    controller.restaurant_Data.value.highlights?[index];
                final price = item?.salePrice ?? item?.regularPrice ?? 0;
                return GestureDetector(
                  onTap: () {
                    specific_product_controllerontroller.specific_Product_Api(
                      productId: controller
                          .restaurant_Data.value.highlights![index].id
                          .toString(),
                      categoryId: controller
                          .restaurant_Data.value.highlights![index].categoryId
                          .toString(),
                    );
                    Get.to(ProductDetailsScreen(
                      ...
                      categoryName: controller.restaurant_Data.value
                              .highlights![index].category?.name
                              .toString() ??
                          "",
                    ));
                  },
                                  ...
                                  onTap: () async {
                                    if (getUserDataController
                                      ...
                                      await addWishlistController
                                        ...
                                        categoryId: controller.restaurant_Data
                                            .value.highlights![index].categoryId
                                            .toString(),
                                        product_id: controller.restaurant_Data
                                            .value.highlights![index].id
                                            .toString(),
                                      );
                                    }
                                  },
                                  child: controller.restaurant_Data.value
                                          .highlights![index].isLoading.value
      ...
      children: [
        ClipRRect(
            ...
            child: CachedNetworkImage(
              memCacheHeight: memCacheHeight,
              width: Get.width,
              imageUrl: controller.restaurant_Data.value.restaurant!.logoUrl.toString(),
        ...
        Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Get.toNamed(AppRoutes.restaurantInformationScreen, arguments: {
        ...
        Container(
          ...
          padding: REdgeInsets.symmetric(vertical: 7, horizontal: 6),
          child: Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  "Free delivery when you spend over \$1009",
 ...
 /* Widget openHours() {
  ...
  Widget moreProducts(context, String? Restaurantid) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          hBox(10),
          controller.restaurant_Data.value.moreProducts!.isEmpty
              ? CustomNoDataFound(heightBox: hBox(0.h))
              : ListView.separated(
                  physics: const NeverScrollableScrollPhysics(),
                  shrinkWrap: true,
                  itemCount:
                      controller.restaurant_Data.value.moreProducts?.length ?? 0,
                    ...
                    return GestureDetector(
                        onTap: () {
                          specific_product_controllerontroller
                            ...
                            productId: controller
                                ...
                                .toString(),
                            categoryId: controller.restaurant_Data.value
                                .moreProducts![index].categoryId
                                .toString(),
                          );
                          Get.to(ProductDetailsScreen(
                        ...
                        child: UpdatedCustomItemBanner(
                          ...
                          categoryId: controller.restaurant_Data.value
                              .moreProducts![index].categoryId
                              .toString(),
                          image: controller.restaurant_Data.value
                              .moreProducts![index].imageUrl,
                          title: controller
                          ...
                          isLoading: controller.restaurant_Data.value
                              .moreProducts![index].isLoading,
                          sale_price: controller.restaurant_Data.value
                              .moreProducts![index].salePrice
                              .toString(),
                          regular_price: controller.restaurant_Data.value
                              .moreProducts![index].regularPrice
                              .toString(),
                          resto_name: controller.restaurant_Data.value
                              .moreProducts![index].restoName
                              .toString(),
                        ));
  ...
  Widget categoriesList() {
    ...
    final categoryKeys = [
      "All",
      ...(controller.restaurant_Data.value.categories?.data.keys.toList() ?? [])
    ];

    return Padding(
      padding: REdgeInsets.only(top: 10, bottom: 15),
      child: SizedBox(
        height: 35,
        child: ListView.separated(
          padding: REdgeInsets.symmetric(horizontal: 24),
            ...
            return Obx(
              () => GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      color: controller.categoriesIndex.value == index
                          ? AppColors.darkText
                          : AppColors.bgColor,
                    ...
                    child: Text(
                      ...
                      style: AppFontStyle.text_15_400(
                          controller.categoriesIndex.value == index
                              ? AppColors.white
                              : AppColors.darkText,
                          family: controller.categoriesIndex.value == index
                              ? AppFontFamily.onestSemiBold
                              : AppFontFamily.onestMedium),
                    ),
                  ),
                ),
              ),
  ...
  Widget categoriesProducts(context, String? restaurantId) {
    ...
    final selectedKey = controller.categoriesIndex.value == 0
        ? "All"
        : categoryKeys[controller.categoriesIndex.value];

    final List<Product> catValue =
        controller.categoriesIndex.value == 0
