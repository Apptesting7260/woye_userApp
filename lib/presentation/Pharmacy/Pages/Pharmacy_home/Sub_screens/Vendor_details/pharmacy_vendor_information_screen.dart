...
import 'PharmacyDetailsController.dart';

class PharmacyVendorInformationScreen extends StatefulWidget {
  const PharmacyVendorInformationScreen({super.key});

  @override
  State<PharmacyVendorInformationScreen> createState() => _PharmacyVendorInformationScreenState();
}

class _PharmacyVendorInformationScreenState extends State<PharmacyVendorInformationScreen> {
  ...
  void initState() {
    ...
    pharmacyId = arguments['pharmacyId'] ?? "";
    pt("pharmacyId >>>>>>>>>>>> $pharmacyId");
    super.initState();
  }
