...
class PharmacyHomeScreen extends StatelessWidget {
  ...
  static final RestaurantHomeController restaurantHomeController =
      Get.put(RestaurantHomeController());

  static final RestaurantNavbarController restaurantNavbarController =
            ...
            itemBuilder: (context, index) {
              return Column(
                children: [
                  CustomRoundedButton(
                    onPressed: () {},
                    child: Image.asset(restaurantHomeController
