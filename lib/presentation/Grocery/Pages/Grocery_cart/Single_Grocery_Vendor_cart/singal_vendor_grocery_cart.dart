...
class SingleVendorGroceryCart extends StatefulWidget {
  ...
  const SingleVendorGroceryCart(
      {super.key, this.isBack = false, required this.cartId});

  @override
  State<SingleVendorGroceryCart> createState() => _GroceryCartScreenState();
}
                  ...
                  child: Transform.scale(
                    ...
                    child: isLoading
                        ...
                        : Checkbox(
                            ...
                            onChanged: (value) {
                              print(groceryCheckUnCheckController
                                  .rxRequestStatusCheckUncheck.value);
                              if (groceryCheckUnCheckController
                                      .rxRequestStatusCheckUncheck.value !=
                                  Status.LOADING) {
