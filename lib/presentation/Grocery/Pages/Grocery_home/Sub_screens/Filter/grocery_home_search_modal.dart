...
class GroceryHomeSearchModal {
  bool? status;
  List<CategoryProduct>? products;
  List<shop>? pharmaShop;
  String? message;

  GroceryHomeSearchModal(
      {this.status, this.products, this.pharmaShop, this.message});

  GroceryHomeSearchModal.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    products = json['products'] != null
        ? (json['products'] as List).map((v) => CategoryProduct.fromJson(v)).toList()
        : [];
    pharmaShop = json['grocery_shops'] != null
        ? (json['grocery_shops'] as List).map((v) => shop.fromJson(v)).toList()
        : [];
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.pharmaShop != null) {
      data['grocery_shops'] = this.pharmaShop!.map((v) => v.toJson()).toList();
    }
